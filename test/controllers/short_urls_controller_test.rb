...
class ShortUrlsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create short_url" do
    assert_difference('ShortUrl.count') do
      post short_urls_url, params: { short_url: { converted: @short_url.converted, original: @short_url.original } }
    end
  ...
  test "should update short_url" do
    patch short_url_url(@short_url), params: { short_url: { converted: @short_url.converted, original: @short_url.original } }
